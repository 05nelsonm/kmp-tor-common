...
internal actual fun jsObjectSet(obj: JsObject, key: String, value: JsArray) { js("obj[key] = value") }
internal actual fun jsObjectSet(obj: JsObject, key: String, value: Boolean) { js("obj[key] = value") }
internal actual fun jsObjectSet(obj: JsObject, key: String, value: Int) { js("obj[key] = value") }
